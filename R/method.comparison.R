...
#'
#' # Call the function
#' method.comparison( measurement1 , measurement2 )
#'
#' @export

method.comparison <- function(method1, method2, sig.level = 0.95) {
    
    # Prepares the data
    comparison.data <- data.preparation(method1, method2, sig.level)
