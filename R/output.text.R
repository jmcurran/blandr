...
#'
#' @description (DEPRECATED) Displays results of Bland-Altman analysis in a nicer text format.
#' Relies on the \code{statistics} function in the package. Deprecated and moved into
#' the \code{print.blandr} generic
#'
...
#' output.text( measurement1 , measurement2 )
#'
#' @export

output.text <- function(method1, method2, sig.level = 0.95) {

    .Deprecated("output.text")

    result <- statistics(method1, method2, sig.level)
