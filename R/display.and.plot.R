...
#'
#' @description (DEPRECATED) Re-directs to display.and.draw
#'
#' @author Deepankar Datta <deepankardatta@nhs.net>
#'
#' @inheritParams display.and.draw
#'
#' @include display.and.draw.r

display.and.plot <- function(method1, method2, method1name = "Method 1", method2name = "Method 2", 
    ...
    .Deprecated("display.and.draw")
    
    display.and.draw(method1, method2, method1name, method2name, plotTitle, sig.level, 
