...
#'
#' @description Works out plot limits for the Bland-Altman plots. Depends on the statistics function in the package.
#'
#' @author Deepankar Datta <deepankardatta@nhs.net>
#'
#' @param statistics.results A list of statistics generated by the statistics function: see the function's return list to see what variables are passed to this function
...
#'
#' # Passes data to the statistics function to generate Bland-Altman statistics
#' statistics.results <- statistics( measurement1 , measurement2 )
#'
#' # Calls the function
#' plot.limits( statistics.results )
#'
#' @export

plot.limits <- function(statistics.results, lowest_y_axis = FALSE, highest_y_axis = FALSE) {
