...
#' display.and.draw( measurement1 , measurement2 )
#'
#' # Generates a plot, with title
#' display.and.draw( measurement1 , measurement2 , plotTitle = 'Bland-Altman example plot' )
#'
#' @export

display.and.draw <- function( method1 , method2, plotter = "ggplot", method1name = "Method 1",
